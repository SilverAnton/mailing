...
urlpatterns = [
    ...
    path("client_detail/main/<int:pk>/", ClientDetailView.as_view(), name="client_detail"),
    ...
    path("message_detail/main/<int:pk>/", MessageDetailView.as_view(), name="message_detail"),
    ...
    path("mailing_list/main", MailingListView.as_view(), name="mailing_list"),
    path("mailing_detail/main/<int:pk>/", MailingDetailView.as_view(), name="mailing_detail"),
